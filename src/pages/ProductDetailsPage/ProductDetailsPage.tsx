...
export const ProductDetailsPage: FC = () => {
  ...
  const handleAddProductToFavorites = (prod: Product) => {
    addProducts(dispatch, favoriteProducts, prod, "favoriteProducts");
  };
    ...
    <div className="product-details">
      ...
      <div className="product-details__preview-container">
            ...
            {images.map((image: string) => (
              <button
                ...
                className={classNames(
                  ...
                  {
                    [`product-details__image-wrapper--active__${theme}`]:
                      currentImage === image,
                  }
                )}
                key={image}
        ...
        <div className="product-details__control-panel">
          <div className="product-details__options">
            <div
              className={`product-details__options-container
            ...
            >
              ...
              <ul className="product-details__available-colors">
                {colorsAvailable.map((color: string) => (
                  ...
                  >
                    <div
                      className={`product-details__color-circle product-details__color-circle--${color}`}
                    />
                  </Link>
                ))}
              </ul>
          ...
          <div className="product-details__add-to-cart-container">
            <div className="product-details__prices">
              <h1
                className={`product-details__discount-price
            ...
            {Object.entries(product)
              ...
              .map((entry) => (
                ...
                >
                  ...
                  <p
                    className={`product-details__value-of-characteristic
      ...
      <div className="product-details__text-container">
        <div className="product-details__about">
          <h2
            className={`product-details__subtitle product-details__subtitle--${theme}`}
          >
            About
          </h2>

          <div
            className={`product-details__about-container product-details__about-container--${theme}`}
          >
            {description.map((article: { title: string; text: string[] }) => (
              <article className="product-details__article" key={article.title}>
                <h3
                  className={`product-details__article-title product-details__article-title--${theme}`}
                >
                  {article.title}
                </h3>
        ...
        <div className="product-details__tech-specs">
          ...
          <div
            className={`product-details__characteristics
